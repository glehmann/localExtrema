...
public:
  ...
  LocalMaximaHistogram * Clone()
    {
    LocalMaximaHistogram * result = new LocalMaximaHistogram();
...
public:
  ...
  typedef MovingHistogramImageFilter<TInputImage, TOutputImage, TKernel,
      typename  Function::LocalMaximaHistogram< typename TInputImage::PixelType, typename TOutputImage::PixelType > >  Superclass;
  ...
  itkTypeMacro(LocalMaximaImageFilter, 
               ImageToImageFilter);
  ...
  typedef typename Function::LocalMaximaHistogram< PixelType, OutputPixelType > HistogramType;
